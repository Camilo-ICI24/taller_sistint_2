...
print(dataset.shape) # Cantidad de filas y columnas
...
variables_independientes = ["horsepower", "age", "mileage"]
...
print("R² =", r2_score(y_prueba, y_predicho)) # Si el R
...
sns.scatterplot(x=y_prueba, y=y_predicho, alpha=0.7, color="green", label="Predicho")
...
nuevo_auto = np.array([[165, 4, 58000]])
